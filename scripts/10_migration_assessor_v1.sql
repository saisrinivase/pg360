...
Usage:
  psql "host=<host> port=<port> dbname=<db> user=<user>" \
    ...
    -v report_file='migration/samples/pg360_report.html' \
    -v report_01_file='migration/samples/pg360_01_type_consistency.html' \
    -v report_02_file='migration/samples/pg360_02_casting_issues.html' \
    -v report_03_file='migration/samples/pg360_03_indexes_needed.html' \
    -v report_04_file='migration/samples/pg360_04_unused_duplicate_indexes.html' \
    -v report_05_file='migration/samples/pg360_05_bloat_report.html' \
    -v report_06_file='migration/samples/pg360_06_partition_health.html' \
    -v report_07_file='migration/samples/pg360_07_config_readiness.html' \
    -v report_08_file='migration/samples/pg360_08_compatibility_matrix.html' \
    -v gate_html_file='migration/samples/pg360_09_gate_summary.html' \
    -v json_file='migration/samples/migration_assessment_v1.json' \
    -v gate_output_file='migration/samples/migration_gate_v1.txt' \
    -v enforce_exit=false \
    -f migration/10_migration_assessor_v1.sql
...
\if :{?report_file}
\else
\set report_file 'pg360_report.html'
\endif

\if :{?report_01_file}
\else
\set report_01_file 'pg360_01_type_consistency.html'
\endif

\if :{?report_02_file}
\else
\set report_02_file 'pg360_02_casting_issues.html'
\endif

\if :{?report_03_file}
\else
\set report_03_file 'pg360_03_indexes_needed.html'
\endif

\if :{?report_04_file}
\else
\set report_04_file 'pg360_04_unused_duplicate_indexes.html'
\endif

\if :{?report_05_file}
\else
\set report_05_file 'pg360_05_bloat_report.html'
\endif

\if :{?report_06_file}
\else
\set report_06_file 'pg360_06_partition_health.html'
\endif

\if :{?report_07_file}
\else
\set report_07_file 'pg360_07_config_readiness.html'
\endif

\if :{?report_08_file}
\else
\set report_08_file 'pg360_08_compatibility_matrix.html'
\endif

\if :{?gate_html_file}
\else
\set gate_html_file 'pg360_09_gate_summary.html'
\endif

\if :{?json_file}
\else
\set json_file 'migration_assessment_v1.json'
\endif

\if :{?gate_output_file}
\else
\set gate_output_file 'migration_gate_v1.txt'
\endif
...
\qecho </ol>
\qecho <div class="foot">Generated by migration/10_migration_assessor_v1.sql</div>
\qecho </body>
\qecho </html>
